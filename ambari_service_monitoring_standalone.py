####################################################################################################################
#
# File:        ambari_service_monitoring_standalone.py
# Description: A simple script to monitor services like (Kafka, Spark, HDFS, Hive, Yarn, Ranger, Flume, Hbase, ...)
#              using Ambari REST API. It works as a service that is always up and runing.
#              If you do not want to use a scheduling tool, then use ambari_service_monitoring.py.
